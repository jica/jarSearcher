...
import org.jarsearcher.utils.Configuration;

public class MainSearcherView extends JFrame implements ActionListener {

    final static Logger logger = Logger.getLogger(MainSearcherView.class.getName());
    ...
    private static final String DEFAULT_PATH = Configuration.getProperty(Configuration.PROP_DEFAULT_PATH);
    private static final String DEFAULT_QUERY = Configuration.getProperty(Configuration.PROP_DEFAULT_QUERY);
    private static final String NEXUS_URL = Configuration.getProperty(Configuration.PROP_NEXUS_URL);
    ...
    public void actionPerformed(ActionEvent evt) {
        logger.log(Level.ALL, "evento " + evt.getActionCommand());
    }

    public static void main(String[] args) {

        logger.log(Level.SEVERE, "PATH:" + DEFAULT_PATH);
        logger.log(Level.SEVERE, "PATH:" + DEFAULT_QUERY);
        logger.log(Level.SEVERE, "PATH:" + NEXUS_URL);
...
//				inst.tabbedPane.setBounds(10, 10, inst.getWidth()-30, 95);
    ...
    public MainSearcherView() {
        try {
            ...
            logger.log(Level.INFO, "There was an error applying the look and feel", e);
        }
        this.initialize();
                ...
                if (row >= 0 && col >= 0) {
                    ...
                    if (desktop != null
                        ...
                        try {
                            ...
                            desktop.browse(new URI(NEXUS_URL + path.substring(path
                                    .lastIndexOf("/") + 1)));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
